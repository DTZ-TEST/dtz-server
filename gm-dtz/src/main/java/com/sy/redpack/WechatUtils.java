...
public class WechatUtils {
    ...
    public static final String WX_ACCESS_USERINFO = "https://api.weixin.qq.com/sns/userinfo";
    ...
    public static WeixinUser getUserInfo(String code) {
        ...
        map.put("appid", WeixinRedbagConfig.getAppId());
        map.put("secret", WeixinRedbagConfig.getAppsecret());
        map.put("code", code);
        map.put("grant_type", "authorization_code");
        String result = com.sy.mainland.util.HttpUtil.getUrlReturnValue(WX_ACCESS_TOKEN, com.sy.mainland.util.HttpUtil.DEFAULT_CHARSET, com.sy.mainland.util.HttpUtil.POST, map);
        monitor.info("load access_token url:{},params:{},result:{}", WX_ACCESS_TOKEN, map, result);
