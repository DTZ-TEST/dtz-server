...
<div class="table2">
    <table cellspacing="0" cellpadding="15" style="width: 100%;text-align: left;vertical-align: middle;">
         <tr onclick="window.location='<%=path%>/page/pay/info?gameId='+localStorage.getItem('gameId')" style="display: none">
            <td style="border-top: 0px;font-size: 22px;">充值查询</td>
            <td style="border-top: 0px;text-align: right;">
                <img src="<%=basePath%>/image/jiantou.png" style="width: 16px;height: 29px;"/>
            </td>
        </tr>
        <tr onclick="window.location='<%=path%>/page/pay/history/player?gameId='+localStorage.getItem('gameId')" style="display: none">
            <td style="font-size: 22px;">玩家充值查询</td>
            <td style="text-align: right;">
                <img src="<%=basePath%>/image/jiantou.png" style="width: 16px;height: 29px;"/>
            </td>
        </tr>
        <tr onclick="window.location='<%=path%>/page/player/info?gameId='+localStorage.getItem('gameId')">
            <td style="font-size: 22px;">玩家信息查询</td>
            <td style="text-align: right;">
                <img src="<%=basePath%>/image/jiantou.png" style="width: 16px;height: 29px;"/>
            </td>
        </tr>
        <tr onclick="window.location='<%=path%>/page/buy/card/info?gameId='+localStorage.getItem('gameId')">
            <td style="font-size: 22px;">售钻记录</td>
            <td style="text-align: right;">
                <img src="<%=basePath%>/image/jiantou.png" style="width: 16px;height: 29px;"/>
            </td>
        </tr>
