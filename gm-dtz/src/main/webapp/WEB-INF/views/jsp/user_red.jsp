...
<table class="header_table" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td><img src="<%=basePath%>/image/user_red.png" class="header_img2" style="width: 94px;"/></td>
...
//                JSON.parse(jsonStr);//字符串转json
    ...
    function save() {
        ...
        var a=myOperate!=2?confirm("确认将该玩家标识为红名吗?"):confirm("确定解除该玩家的红名吗?");
        if (a==true)
        $.ajax({
            timeout: 60000,
            async: true,
