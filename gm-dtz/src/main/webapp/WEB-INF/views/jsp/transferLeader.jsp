...
<table class="header_table" cellpadding="0" cellspacing="0">
    <tr>
        ...
        <td><img src="<%=basePath%>/image/transferLeader.png" class="header_img2" style="width: 94px;"/></td>
...
<div style="text-align: center;width: 100%;">
    <table cellpadding="0" cellspacing="15" style="width: 100%;">
        ...
        <tr>
            <td>
                <input id="pwd" class="text-input" type="text" pattern="[0-9]*" placeholder="亲友圈id">
            </td>
        </tr>
        <tr>
            <td>
                <input id="pwd1" class="text-input" type="text" pattern="[0-9]*" placeholder="被转移玩家id">
            </td>
        </tr>
        <tr>
            <td>
                <input class="text-input" style="" type="text" pattern="[0-9]*" id="tel_code" placeholder="转移到玩家id">
            </td>
        </tr>
        <tr>
            <td>
...
//        }
        ...
        if (!pwd.length>0&&!pwd.length>0&&!pwd.length>0){
            alert("请输入正确的数字");
            return;
        }
