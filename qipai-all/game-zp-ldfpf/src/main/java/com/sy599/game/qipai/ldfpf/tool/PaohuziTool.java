...
import com.sy599.game.qipai.ldfpf.been.PaohuziHandCard;
import com.sy599.game.qipai.ldfpf.been.PaohuziHuBean;
    ...
    public static synchronized boolean checkDihu(List<List<PaohzCard>> list,int playerCount){
        ...
        for (int i = 1; i < playerCount; i++) {
            ...
            for (int j = 0; j < banker.size(); j++) {
                ...
                List<PaohuziHuLack> hulist = isHuNew1(PaohuziTool.getPaohuziHandCardBean(copy), null, false, false, true);
