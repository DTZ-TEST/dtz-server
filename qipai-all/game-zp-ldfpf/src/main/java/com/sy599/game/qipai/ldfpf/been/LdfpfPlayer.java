...
//        }
    ...
    public PaohuziHuLack checkPaoHu(PaohzCard card, boolean isSelfMo, boolean canDiHu) {
        ...
        for (PaohuziHuLack hu:list){
            ...
            if (hu.getHuxi() + totalHuxi >= getPlayingTable(LdfpfTable.class).getFloorValue()){
                setHuxi(hu.getHuxi());
                return hu;
            }
        }
...
//            return null;
    ...
    public PlayerInTableRes.Builder buildPlayInTableInfo(long lookUid, boolean isrecover) {
        ...
        if (table.isSendDaniao() && state == player_state.ready && table.getDaNiaoType() > 0) {
    ...
    public void setAlreadyDaniao(boolean alreadyDaniao) {
        ...
        if (alreadyDaniao)
            System.out.println("=============userId="+userId+"已打鸟");
    }
