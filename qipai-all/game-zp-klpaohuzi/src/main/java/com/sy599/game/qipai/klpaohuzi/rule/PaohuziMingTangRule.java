package com.sy599.game.qipai.klpaohuzi.rule;

import com.sy599.game.qipai.klpaohuzi.bean.CardTypeHuxi;
...
public class PaohuziMingTangRule {
	 ...
	 * @return
	 */
	public static List<Integer> calcMingTang(KlPaohuziPlayer player){
		List<Integer> mtList = new ArrayList<>();
	...
	public static int calcMingTangFen(KlPaohuziPlayer player, List<Integer> mt){
		if(player == null){
			return 0;
		}
