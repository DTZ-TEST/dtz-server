package com.sy599.game.qipai.bbtz.util;
...
public final class CardUtils {
    ...
    public static int compare(List<CardValue> cardValues1, List<CardValue> cardValues2, int siDai) {
        return calcCardValue(cardValues1, siDai).compareTo(calcCardValue(cardValues2, siDai));
    }
     ...
     * @return
     */
    public static Result calcCardValue(List<CardValue> cardValues, int siDai) {
...
//                            }
    ...
    public static List<CardValue> searchBiggerCardValues(List<CardValue> src, List<CardValue> search, int siDai) {
        return searchBiggerCardValues(src, calcCardValue(search, siDai), siDai);
    }
...
//                                    }
    ...
    public static class Result implements Comparable<Result> {
        /**
         * 0无效，1单张，2对子，3三飘，4四带，11单顺子，22双顺子，33飞机，100炸弹
         */
     ...
     * @return
     */
    public static List<Integer> loadSortCards(List<Integer> cards, Result cardResult,int siDai) {
        if (cardResult == null) {
            cardResult = CardUtils.calcCardValue(loadCards(cards),siDai);
        }
