...
import com.sy.sanguo.common.executor.task.TenMinuteFixedRateTask;
...
public class InitData {
	...
	public void init() {
		try {
			...
			TaskExecutor.getInstance().scheduleWithFixedRate(new TenMinuteFixedRateTask(), TenMinuteFixedRateTask.loadFirstExecuteDate(), 1 * 60 * 1000);
...
//			 String user = jdbcProperties.getProperty("jdbc.user");
			...
			LogUtil.i("jdbc.password:"+des.decrypt(pw));
