...
//                setToCache(user);
    ...
    public UserExtendInfo getUserExtendinfByUserId(long userId) throws SQLException {
        UserExtendInfo userExtendInfo = (UserExtendInfo) this.getSqlMapClient().queryForObject("user.getUserExtendinfByUserId", userId);
    ...
    public int updateUser(Long userId, Map<String, Object> modify) {
        ...
        try{
            ...
            if (time1 > 50) {
                GameBackLogger.SYS_LOG.info("user updateUser-->" + userId + " time:" + time1);
            }
        }catch (Exception e){
            update = -1;
...
//            marqueeMap.put("content","恭喜"+user.getName()+"抽中"+prize.get(lottyIndex));
    ...
    public String updateUserMsgVerify(long userId,String phoneNum,String ip)throws SQLException{
        String code=rand.nextInt(900000)+100000+"";
        Map<String, Object> param = new HashMap<String, Object>();
