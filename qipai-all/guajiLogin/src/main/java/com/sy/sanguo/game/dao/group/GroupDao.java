...
public class GroupDao extends CommonDaoImpl {
    ...
    public GroupTable loadGroupTable(long keyId) throws Exception{
        Map<String,Object> map=new HashMap<>(8);
        map.put("keyId",String.valueOf(keyId));
    ...
    public List<HashMap<String,Object>> loadTableUserInfo(String tableNos) throws Exception{
        return (List<HashMap<String,Object>>)this.getSqlMapClient().queryForList("group.load_table_user_info",tableNos);
    }

    public List<HashMap<String,Object>> loadTableUsersByTableNo(String tableNo) throws Exception{
        return (List<HashMap<String,Object>>)this.getSqlMapClient().queryForList("group.load_table_users_tableNo",tableNo);
    }

//    public List<HashMap<String,Object>> loadGroupTableConfigNum(String tableNos) throws Exception{
//        return (List<HashMap<String,Object>>)this.getSqlMapClient().queryForList("group.load_group_table_config_num",tableNos);
//    }

    public List<HashMap<String,Object>> loadGroupTables(String tableNos) throws Exception{
    ...
    public List<HashMap<String,Object>> loadGroupUserMsgs(int groupId,int pageNo,int pageSize,String userGroup,String orderRule) throws Exception{
        return loadGroupUserMsgs(groupId, pageNo, pageSize,null,false,userGroup,orderRule);
    }

    public List<HashMap<String, Object>> searchGroupUserByUserId(int groupId, long userId) throws Exception {
        return loadGroupUserMsgs(groupId, 1, 100, String.valueOf(userId), false, null, null);
    }

    public List<HashMap<String, Object>> loadGroupUserMsgs(int groupId, int pageNo, int pageSize, String keyWord, boolean fuzzySearch, String userGroup, String orderRule) throws Exception {
        Map<String,Object> map=new HashMap<>(8);
        map.put("groupId",String.valueOf(groupId));
        map.put("startNo",(pageNo-1)*pageSize);
        map.put("pageSize",pageSize);
        ...
        if(fuzzySearch) {
            map.put("fuzzySearch", fuzzySearch);
        }
    ...
    public int updateGroupTable(String groupId,String userId) throws Exception{
        Map<String,Object> map=new HashMap<>(8);
        map.put("groupId",groupId);
        map.put("userId",userId);
        return this.getSqlMapClient().update("group.update_group_table_all",map);
    }
    ...
    public int updateGroupTableByKeyId(String keyId,int currentCount0) throws Exception{
        Map<String,Object> map=new HashMap<>(8);
        map.put("keyId",keyId);
        if(currentCount0 > 0){
    ...
    public List<GroupTable> getUserPlayLogGroupTable(String tableNoStr) throws Exception{
    ...
    public List<HashMap<String, Object>> loadTableUserByTableNo(String tableNoStr) throws Exception{
        return (List<HashMap<String, Object>>) this.getSqlMapClient().queryForList("group.loadTableUserByTableNo",tableNoStr);
    }
    ...
    public List<HashMap<String,Object>> loadGroupData(String dataType,String groupId,String startDate,String endDate) throws Exception{
        String sqlId;
        switch (dataType){
            case "zjs":
                sqlId = "group.group_data_zjs";
                break;
            case "dyj":
                sqlId = "group.group_data_dyj";
                break;
            default:
                return null;
        }
    ...
    public int insertGroupCreditLog(HashMap<String,Object> map) throws Exception{
        return this.getSqlMapClient().update("group.insert_group_credit_log",map);
    }
    ...
    public int copyGroup(long srcGroupId, long destGroupId) throws Exception {
        Map<String, Object> map = new HashMap<>(8);
        map.put("srcGroupId", srcGroupId);
        map.put("destGroupId", destGroupId);
        return this.getSqlMapClient().update("group.copyGroup", map);
    }

    public int copySubGroup(long srcGroupId, long destGroupId) throws Exception {
        Map<String, Object> map = new HashMap<>(8);
        map.put("srcGroupId", srcGroupId);
        map.put("destGroupId", destGroupId);
        return this.getSqlMapClient().update("group.copySubGroup", map);
    }

    public int copyGroupUser(long srcGroupId, long destGroupId) throws Exception {
        Map<String, Object> map = new HashMap<>(8);
        map.put("srcGroupId", srcGroupId);
        map.put("destGroupId", destGroupId);
        return this.getSqlMapClient().update("group.copyGroupUser", map);
    }

    public int setGroupRelationOldKey(long srcGroupId) throws Exception {
        Map<String, Object> map = new HashMap<>(8);
        map.put("groupId", srcGroupId);
        return this.getSqlMapClient().update("group.setGroupRelationOldKey", map);
    }

    public int copyGroupRelation(long srcGroupId, long destGroupId) throws Exception {
        Map<String, Object> map = new HashMap<>(8);
        map.put("srcGroupId", srcGroupId);
        map.put("destGroupId", destGroupId);
        return this.getSqlMapClient().update("group.copyGroupRelation", map);
    }

    public int resetUserGroupForCopy(long destGroupId) throws Exception {
        Map<String, Object> map = new HashMap<>(8);
        map.put("groupId", destGroupId);
        return this.getSqlMapClient().update("group.resetUserGroupForCopy", map);
    }

    public int copyGroupTableConfig(long srcGroupId, long destGroupId) throws Exception {
        Map<String, Object> map = new HashMap<>(8);
        map.put("srcGroupId", srcGroupId);
        map.put("destGroupId", destGroupId);
        return this.getSqlMapClient().update("group.copyGroupTableConfig", map);
    }

    public int copySubGroupTableConfig(long srcGroupId, long destGroupId) throws Exception {
        Map<String, Object> map = new HashMap<>(8);
        map.put("srcGroupId", srcGroupId);
        map.put("destGroupId", destGroupId);
        return this.getSqlMapClient().update("group.copySubGroupTableConfig", map);
    }

    public GroupInfo loadGroupInfoState0(long groupId) throws Exception{
        Map<String,Object> map=new HashMap<>(8);
        map.put("groupId",String.valueOf(groupId));
        map.put("parentGroup","0");
        return (GroupInfo)this.getSqlMapClient().queryForObject("group.loadGroupInfoState0",map);
    }

    public GroupInfo loadGroupInfoAllState(long groupId) throws Exception{
        Map<String,Object> map=new HashMap<>(8);
        map.put("groupId",String.valueOf(groupId));
        map.put("parentGroup","0");
        return (GroupInfo)this.getSqlMapClient().queryForObject("group.loadGroupInfoAllState",map);
    }
    ...
    public int forbidGroupUser(GroupUser target, int userLevel, int stateType) throws Exception {
        ...
        if (stateType == 0) {
            ...
            if (GroupConstants.isMember(target.getUserRole()) || GroupConstants.isAdmin(target.getUserRole())) {
                andSql = " AND userId = " + target.getUserId();
            } else if (GroupConstants.isTeamLeader(target.getUserRole())) {
                andSql = " AND userGroup = '" + target.getUserGroup() + "'";
            } else if (GroupConstants.isPromotor(target.getUserRole())) {
                andSql = " AND promoterId" + target.getPromoterLevel() + " = " + target.getUserId();
            }
        }
        map.put("andSql", andSql);
        return this.getSqlMapClient().update("group.forbidGroupUser", map);
    }
