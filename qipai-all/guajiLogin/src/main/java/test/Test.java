...
//            System.out.println(loadInsertSql("t_user_extend", UserExtend.class,"keyId"));
//            System.out.println(SecretUtil.encrypt("",null));
//            System.out.println(Calendar.getInstance().get(Calendar.DAY_OF_WEEK));
//            System.out.println(com.sy.mainland.util.HttpUtil.getUrlReturnValue("http://192.168.1.88:8109/qipai/pdk.do?userId=558fdhdf公司打官司的86840-=9","UTF-8","GET"));
//            Map<String,String> map =new HashMap<>();
//            for (int i=0;i<200;i++){
//                map.put("p"+i,"大公司455gs8690-213453\']"+i);
//            }
//            System.out.println(com.sy.mainland.util.HttpUtil.getUrlReturnValue("http://192.168.1.88:8109/online/notice.do?userId=558fdhdf公司打官司的86840-=9/*-","UTF-8","POST",map));
