...
public class SqlMapClientImpl implements SqlMapClient, ExtendedSqlMapClient {
    ...
    public Object insert(String id, Object param) throws SQLException {
        ...
        try {
            ...
            long t = time == null ? 10 : time.longValue();
            long t2 = System.currentTimeMillis() - t1;
            if (t2 > t) {
                logger.info((new StringBuilder(256)).append("currentThread:").append(Thread.currentThread().toString()).append(" method:insert").append(" first param:").append(id).append(" time(ms):").append(t2).toString());
            }
        }
    }
    ...
    public int update(String id, Object param) throws SQLException {
        ...
        try {
            ...
            long t2 = System.currentTimeMillis() - t1;
            if (t2 > t) {
                logger.info((new StringBuilder(256)).append("currentThread:").append(Thread.currentThread().toString()).append(" method:update").append(" first param:").append(id).append(" time(ms):").append(t2).toString());
            }
        }
    }
    ...
    public int delete(String id, Object param) throws SQLException {
        ...
        try {
            ...
            long t2 = System.currentTimeMillis() - t1;
            if (t2 > t) {
                logger.info((new StringBuilder(256)).append("currentThread:").append(Thread.currentThread().toString()).append(" method:delete").append(" first param:").append(id).append(" time(ms):").append(t2).toString());
            }
        }
    }
    ...
    public Object queryForObject(String id, Object paramObject) throws SQLException {
        ...
        try {
            ...
            long t2 = System.currentTimeMillis() - t1;
            if (t2 > t) {
                logger.info((new StringBuilder(256)).append("currentThread:").append(Thread.currentThread().toString()).append(" method:queryForObject").append(" first param:").append(id).append(" time(ms):").append(t2).toString());
            }
        }
    }
    ...
    public List queryForList(String id, Object paramObject) throws SQLException {
        ...
        try {
            ...
            long t2 = System.currentTimeMillis() - t1;
            if (t2 > t) {
                logger.info((new StringBuilder(256)).append("currentThread:").append(Thread.currentThread().toString()).append(" method:queryForList").append(" first param:").append(id).append(" time(ms):").append(t2).toString());
            }
        }
    }
    ...
    public PaginatedList queryForPaginatedList(String id, Object paramObject, int pageSize) throws SQLException {
        ...
        try {
            ...
            long t2 = System.currentTimeMillis() - t1;
            if (t2 > t) {
                logger.info((new StringBuilder(256)).append("currentThread:").append(Thread.currentThread().toString()).append(" method:queryForPaginatedList").append(" first param:").append(id).append(" time(ms):").append(t2).toString());
            }
        }
    }
    ...
    public Map queryForMap(String id, Object paramObject, String keyProp) throws SQLException {
        ...
        try {
            ...
            long t2 = System.currentTimeMillis() - t1;
            if (t2 > t) {
                logger.info((new StringBuilder(256)).append("currentThread:").append(Thread.currentThread().toString()).append(" method:queryForMap").append(" first param:").append(id).append(" time(ms):").append(t2).toString());
            }
        }
    }
