...
public class UserActivityRecord {
     ...
     * 老玩家回归，记录玩家领取是否打过一局
     */
    private boolean oldBackGiftPlayOne;
    ...
    public boolean isOldBackGiftPlayOne() {
        return oldBackGiftPlayOne;
    }

    public void setOldBackGiftPlayOne(boolean oldBackGiftPlayOne) {
        this.oldBackGiftPlayOne = oldBackGiftPlayOne;
    }
}
